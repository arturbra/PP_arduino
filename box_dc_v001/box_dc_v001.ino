...
void setup() {
  ...
  createTemperatureFile(9);
  createTemperatureFile(10);
...
// 
    ...
    saveTemperatureValue(9, Fahrenheit);
    saveTemperatureValue(10, Fahrenheit2);
  }
...
void createTemperatureFile(int sensorNumber){
  String filename = "/box_dc_temperature_" + String(sensorNumber) + ".txt";
